        ...
        <form action = "<?=action(\Controllers\Usuarios\Cadastro::class, 'save', 'POST')?>" method="POST">
          <div class="card-body row">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" name="telefone" class="form-control" placeholder="(XX) 9 9999 - 9999" id="inputTelefone" value="<?=value($telefone)?>" required>
            </div>
            <div class="form-group col-md-3">
              <label for="inputCPF">
            ...
            <div class="form-group col-md-3">
              <label for="inputRG_expedidor">
                RG_expedidor: <span class="text-danger">*</span>
              </label>
